...
namespace game_module
{
	...
	public:
		...
		void add_points(size_type player_color, size_type points);
		void set_winner(size_type player_color);
		void set_last_turn(size_type player_color, size_type turn);
		void add_to_built_armies(size_type player_color, size_type number = 1);
