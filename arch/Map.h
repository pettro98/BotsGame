...
namespace game_module
{
	...
	*/
	...
	/*!
	\brief Функция выводит визуализацию переданной карты в терминал.
	- В конечной версии проекта не используется.

	\param map Карта, которую необходимо вывести.
	*/
	...
	*/
	struct MapImpress
	{
		...
		*/
		...
		/*!
		\brief Унарный оператор возвращает указатель на гекс с переданными координатами.
		- В случае если гекса с такими координатами нет возвращает гекс с координатами (0, 0),
		цветом black, типом юнита none.
